...
// Resim koruma - sağ tık ve sürükleme engelleme
...
// Tüm resimler için genel koruma
...
window.addEventListener('scroll', () => {
    ...
    if (window.scrollY > 100) {
        ...
        if (navLogo) {
            navLogo.style.background = 'linear-gradient(135deg, #2c3e50 0%, #34495e 100%)';
        ...
        // Logo rengini açık renge döndür
        if (navLogo) {
            navLogo.style.background = 'linear-gradient(135deg, #667eea 0%, #764ba2 100%)';
            navLogo.style.webkitBackgroundClip = 'text';
            navLogo.style.webkitTextFillColor = 'transparent';
        }
    }
...
backToTopButton.addEventListener('mouseenter', () => {
    ...
    backToTopButton.style.boxShadow = '0 6px 25px rgba(52, 152, 219, 0.4)';
});

backToTopButton.addEventListener('mouseleave', () => {
    backToTopButton.style.transform = 'translateY(0)';
    backToTopButton.style.boxShadow = '0 4px 20px rgba(52, 152, 219, 0.3)';
});

console.log('İç Mimar Portfolio sitesi başarıyla yüklendi! 🏠✨');